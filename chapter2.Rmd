...
The plot above demonstrates the distributions of the variables and the relationships between them on males (blue) and females (red). As for exam points, attitude has the strongest correlation. Overall, there are minor differences on the distributions and relationships between genders but nothing outstanding. 
